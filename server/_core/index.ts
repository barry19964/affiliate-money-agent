...
import { handleContentGenerationSchedule, handleTrendDetectionSchedule } from "../schedulers/handlers";
import {
  handleNichePivotingJob,
  handleInfluencerOutreachJob,
  handleVideoGenerationJob,
  handleAdOptimizationJob,
  handleSmartNotificationsJob,
} from "../scheduled/hyperAutomationJobs";
...
async function startServer() {
  ...
  // Scheduler handlers (MUST be before Vite/static fallthrough)
  ...
  // Hyper-automation scheduled jobs
